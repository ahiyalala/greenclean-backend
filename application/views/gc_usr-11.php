         ...
         <div class="card-body">
            <form>
               <div class="form-group mx-2">
                  ...
                  <input type="text" class="form-control" name="full_name" id="exampleFormControlInput1" placeholder="gella.faffy@gmail.com">
               </div>
               <div class="form-group mx-2">
                  <label for="exampleFormControlInput1">Address 1:</label>
                  <input type="text" class="form-control" name="address1" id="exampleFormControlInput1" placeholder="gella.faffy@gmail.com">
               </div>
               <div class="form-group mx-2">
                  <label for="exampleFormControlInput1">Address 2:</label>
                  <input type="text" class="form-control" name="address2" id="exampleFormControlInput1" placeholder="gella.faffy@gmail.com">
               </div>
               <div class="form-group mx-2">
