...
<body>
    <div>
            ...
            <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                <div class="container">
                    <a class="navbar-brand" href="#">
                        <img src="front/img/icon-full.png" width="56px"></a>
            ...
            <div class="container hero">
                <div class="row">
                    <div class="col-12 col-lg-6 col-xl-5 offset-xl-1">
                        ...
                        <a class="btn btn-light btn-lg action-button" href="#book-now">Book your cleaning now!</a>
                    </div>
                    <div class="col-md-5 col-lg-5 offset-lg-1 offset-xl-0 d-none d-lg-block phone-holder">
                        <div class="iphone-mockup">
                            <img src="front/img/screen_nexus5x-portrait.png" style="width:100%">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="highlight-phone" id="book-now">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-lg-7">
                        <div class="intro">
                            <h2>We treat your home like it is ours. </h2>
                            <p>Download the app now and start booking today!</p>
        ...
        <footer>
            <div class="row">
                <div class="col-sm-6 col-md-4 footer-navigation">
                    <h3>
                        <img class="footer-company-logo" src="<?php echo base_url('/front/img/icon-full.png'); ?>" />
                    </h3>
                    <p class="links">
                        <a href="#">Home</a>
                        <!-- <strong> | </strong>
                        ...
                        <strong> | </strong>
                        <a data-toggle="modal" data-target="#myModalFAQ">FAQs</a>
                    </p>
                    <p class="company-name">GreenKlean © 2018 </p>
                </div>
                <div class="col-sm-6 col-md-4 footer-contacts">
                    <div>
                        <span class="fa fa-map-marker footer-contacts-icon"> </span>
                        <p>
                            <span class="new-line-span">30M Aspire Tower, Calle Industria</span> Quezon City, Philippines</p>
                    </div>
                    <div>
                        <i class="fa fa-phone footer-contacts-icon"></i>
                        <p class="footer-center-info email text-left">+63 917 585 5236</p>
                    </div>
                    <div>
                ...
                <div class="col-md-4 footer-about">
                    ...
                    <div class="social-links social-icons">
                        ...
                        <a href="https://www.instagram.com/greenklean.ph/">
                        ...
                        <div id="accordion">
                            ...
                            <div class="card">
                                ...
                                <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordion">
                                    <div class="card-body text-dark" style="text-align:justify">
                                        You may pay by cash or upon booking online using credit card (coming soon!).
                                    </div>
                                </div>
                            </div>
