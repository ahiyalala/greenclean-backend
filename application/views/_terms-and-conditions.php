...
<head>
    ...
    <title>GreenKlean - Terms and Conditions</title>
    <link rel="stylesheet" href="<?php echo base_url('css/bootstrap.min.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('fonts/font-awesome.min.css'); ?>">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Cookie">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,700">
    <link rel="stylesheet" href="<?php echo base_url('css_admin/Features-Blue.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('css_admin/Project-Clean.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('css_admin/Header-Blue.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('css_admin/Highlight-Phone.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('css_admin/Pretty-Footer.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('css_admin/Registration-Form-with-Photo.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('css_admin/styles.css'); ?>">
...
modify the app, any part of the app, or our trademarks in any way. You’re not allowed to attempt to
extract the source code of the app, and you also shouldn’t try to translate the app into other
languages, or make derivative versions. The app itself, and all the trade marks, copyright, database
rights and other intellectual property rights related to it, still belong to Green Klean.
    </p>
    <p>
      Green Klean is committed to ensuring that the app is as useful and efficient as possible. For that
...
to you exactly what you’re paying for.
    ...
    <p>
      The Green Klean app stores and processes personal data that you have provided to us, in order to
...
make your phone vulnerable to malware/viruses/malicious programs, compromise your phone’s
security features and it could mean that the Green Klean app won’t work properly or at all
    </p>
    <p>
      You should be aware that there are certain things that Green Klean will not take responsibility for.
Certain functions of the app will require the app to have an active internet connection. The
connection can be Wi-Fi, or provided by your mobile network provider, but Green Klean cannot take
responsibility for the app not working at full functionality if you don’t have access to Wi-Fi, and you
...
payer for using the app.
    ...
    <p>
      Along the same lines, Green Klean cannot always take responsibility for the way you use the app i.e.
You need to make sure that your device stays charged – if it runs out of battery and you can’t turn it
on to avail the Service, Green Klean cannot accept responsibility.
    </p>
    <p>
      With respect to Green Klean’s responsibility for your use of the app, when you’re using the app, it’s
...
Green Klean accepts no liability for any loss, direct or indirect, you experience as a result of relying
...
Green Klean does not promise that it will always update the app so that it is relevant to you and/or
works with the Android & iOS version that you have installed on your device. However, you promise
...
we tell you otherwise, upon any termination, (a) the rights and licenses granted to you in these terms
will end; (b) you must stop using the app, and (if needed) delete it from your device.
    </p>
    <h5 class="document-subheader">Changes to This Terms and Conditions</h5>
    <p>
      We may update our Terms and Conditions from time to time. Thus, you are advised to review this
page periodically for any changes. We will notify you of any changes by posting the new Terms and
Conditions on this page. These changes are effective immediately after they are posted on this
page.
    </p>
    <h5 class="document-subheader">Contact Us</h5>
    <p>
...
us.
    ...
    <script src="<?php echo base_url('front/js/scrollspy.js'); ?>"></script>
