    ...
    <div class="nav">
      <nav class="navbar navbar-light navbar-toggleable-md bg-success fixed-top">
        ...
        <a class="navbar-brand" href="#">
          <img src="https://via.placeholder.com/120x50" class="img-responsive" alt="Cinque Terre">
        </a>
        <div class="collapse navbar-collapse flex-row-reverse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item m-2 dropdown">
              <a class="nav-link dropdown-toggle  dropleft" href="#" data-toggle="dropdown">
                <img src="https://via.placeholder.com/30x30"" class="img-responsive rounded-circle" alt="APPLE" width="30" height="30">
              </a>
